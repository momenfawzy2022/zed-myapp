    ...
    <div className={darkMode ? "dark" : ""}>
      ...
      <main className="bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900">
        <section className="min-h-screen">
          ...
          <h1 className='text-xl font-burtons'>HunterCode</h1>
          ...
          <div className='text-center p-10'>
            <h2 className='text-5xl py-2 text-teal-600 font-medium md:text-6xl'>Momen Fawzy</h2>
        ...
        <section>
          <div className='shadow-lg mt-10 p-10 rounded-xl dark:bg-white '>
            <h3 className='text-3xl py-1'>services I offerr</h3>
            ...
            <div className="grid justify-items-center shadow-lg p-10 rounded-xl my-10 dark:bg-white">
